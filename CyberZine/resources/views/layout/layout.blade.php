            ...
            <div class="wrapper">
                ...
                <nav class="nav-2">
                    <ul class="nav-categories">
                        ...
                        <li><a href="{{route('categories.automobile', ['cat_id' => '3'])}}">Automobile</a></li>
                        <li><a href="{{route('categories.realestate', ['cat_id' => '4'])}}">Real Estate</a></li>
                        <li><a href="{{route('categories.travel', ['cat_id' => '5'])}}">Travel</a></li>
                        <li><a href="{{route('categories.business', ['cat_id' => '6'])}}">Business</a></li>
                        <li><a href="{{route('categories.economy', ['cat_id' => '7'])}}">Economy</a></li>
