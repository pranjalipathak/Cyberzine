...
Route::get('/automobile/{cat_id}', [CategoryController::class, 'automobile'])->name('categories.automobile');
Route::get('/realestate/{cat_id}', [CategoryController::class, 'realestate'])->name('categories.realestate');
...
Route::get('/economy/{cat_id}', [CategoryController::class, 'economy'])->name('categories.economy');
